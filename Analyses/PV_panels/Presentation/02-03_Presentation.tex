...
\begin{frame}{Experimental Results}
	\begin{figure}
	\includegraphics[width=0.6\textwidth]{batch_normalization_results_1.png}
...
\begin{frame}{Experimental Results}
	\begin{figure}
	\includegraphics[width=0.3\textwidth]{batch_normalization_results_2.png}
	\caption{(\emph{Top}) Query images. (\emph{Bottom}) CNN estimated crack probabilities.}
	\end{figure}
\end{frame}
...
\textbf{Line detection contd.}
	...
	\begin{figure}
	\includegraphics[width=1\textwidth]{line_detector_score.pdf}
